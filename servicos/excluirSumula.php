...
$consulta = "DELETE FROM placar_partidas WHERE idTimeHasTorneio='$idJogo'";
$excluirSumula->editarOcorrencia($consulta);
$consulta = "alter table placar_partidas auto_increment=1";

$excluirSumula->salvaOcorrencia($consulta);


header("refresh:1; url=./contabilizarGoals.php?pagina=5");
