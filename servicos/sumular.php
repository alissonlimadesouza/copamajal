...
/*
 * Programação para salvar os gols time A
 * 
 */
...
/*
 * Programação para salvar o total de gols em cada partida
 * na tabela placar partidas do time A.
 * 
 */
...
$consulta = "INSERT INTO placar_partidas VALUES ('','$idJogo','$idTimeA','$totalGolsA','','','','','','','')";
$sumular->salvaOcorrencia($consulta);
...
/*
 * Fim da programação para salvar o total de gols em cada partida
 * na tabela placar partidas do time A
 * 
 */
...
/*
 * Programação para salvar o total de gols em cada partida
 * na tabela placar partidas do time B
 * 
 */
...
$consulta = "INSERT INTO placar_partidas VALUES ('','$idJogo','$idTimeB','$totalGolsB','','','','','','','')";
$sumular->salvaOcorrencia($consulta);
...
/*
 * Fim da programação para salvar o total de gols em cada partida
 * na tabela placar partidas do tme B
 * 
 */
...
/*
 * 
 * Programação que contabiliza a cada jogo o total de pontos no campeonato
 */


if ($totalGolsA > $totalGolsB) {
    $consulta = "UPDATE placar_partidas SET pontoPositivo='3' , golNegativo='$totalGolsB', vitoria='1', derrota='0', empate='0' WHERE idTimeHasTorneio='$idJogo' AND idTime='$idTimeA'";
    $sumular->salvaOcorrencia($consulta);



    $consulta = "UPDATE placar_partidas SET pontoPositivo='0' , golNegativo='$totalGolsA', vitoria='0', derrota='1', empate='0' WHERE idTimeHasTorneio='$idJogo' AND idTime='$idTimeB'";
    $sumular->salvaOcorrencia($consulta);



    $consulta = "select * from placar_partidas where  idTime='$idTimeA' ";
    $contagem = $sumular->contaOcorrencias($consulta);
    $totalPontos = $sumular->listaOcorrencia($consulta, 'pontoPositivo');
    for ($i = 0; $i < $contagem; $i++) {
        $novoTotal = $novoTotal + $totalPontos[$i];
    }
    $consulta = "UPDATE placar_partidas SET totalPonto='$novoTotal' WHERE idTimeHasTorneio='$idJogo' AND idTime='$idTimeA'";
    $sumular->salvaOcorrencia($consulta);
} elseif
 ($totalGolsA < $totalGolsB) {
    $consulta = "UPDATE placar_partidas SET pontoPositivo='0' , golNegativo='$totalGolsB', vitoria='0', derrota='1', empate='0' WHERE idTimeHasTorneio='$idJogo' AND idTime='$idTimeA'";
    $sumular->salvaOcorrencia($consulta);



    $consulta = "UPDATE placar_partidas SET pontoPositivo='3' , golNegativo='$totalGolsA', vitoria='1', derrota='0', empate='0' WHERE idTimeHasTorneio='$idJogo' AND idTime='$idTimeB'";
    $sumular->salvaOcorrencia($consulta);



    $consulta = "select * from placar_partidas where  idTime='$idTimeB' ";
    $contagem = $sumular->contaOcorrencias($consulta);
    $totalPontos = $sumular->listaOcorrencia($consulta, 'pontoPositivo');
    for ($i = 0; $i < $contagem; $i++) {
        $novoTotal = $novoTotal + $totalPontos[$i];
    ...
    $consulta = "UPDATE placar_partidas SET totalPonto='$novoTotal' WHERE idTimeHasTorneio='$idJogo' AND idTime='$idTimeB'";
    $sumular->salvaOcorrencia($consulta);
} elseif ($totalGolsA == $totalGolsB) {
    $consulta = "UPDATE placar_partidas SET pontoPositivo='0' , golNegativo='$totalGolsB', vitoria='0', derrota='0', empate='1' WHERE idTimeHasTorneio='$idJogo' AND idTime='$idTimeA'";
    $sumular->salvaOcorrencia($consulta);

    $consulta = "UPDATE placar_partidas SET pontoPositivo='0' , golNegativo='$totalGolsA', vitoria='0', derrota='0', empate='1' WHERE idTimeHasTorneio='$idJogo' AND idTime='$idTimeB'";
    $sumular->salvaOcorrencia($consulta);
}
...
/*
 * 
 * Fim da programação que contabiliza a cada jogo o total de pontos no campeonato
 */
...
/*
 * 
 * Programação que contabiliza a cada jogo saldo de gols.
 */

$saldoGolsA = $totalGolsA - $totalGolsB;


$consulta = "UPDATE placar_partidas SET saldoGol='$saldoGolsA' WHERE idTimeHasTorneio='$idJogo' AND idTime='$idTimeA'";
$sumular->salvaOcorrencia($consulta);



$saldoGolsB =  $totalGolsB -  $totalGolsA ;


$consulta = "UPDATE placar_partidas SET saldoGol='$saldoGolsB' WHERE idTimeHasTorneio='$idJogo' AND idTime='$idTimeB'";
$sumular->salvaOcorrencia($consulta);
...
/*
 * 
 * Fim da programação que contabiliza a cada jogo saldo de gols.
 */
